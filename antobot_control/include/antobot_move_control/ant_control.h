...
Description: 	The primary purpose of am_control is to serve as a communication channel between the ROS components of
		...
		This is the header file. See ant_control.cpp for source code and more information.
...
#include <antobot_move_control/ant_hardware.h>
